...
class _SoundSheetState extends State<SoundSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedId = settings.salahSound;
                ...
                itemBuilder: (ctx, i) {
                  ...
                  return GestureDetector(
                    onTap: () async {
                      ...
                      // 3. Update the settings cubit in the background
                      await context.read<SettingsCubit>().setSalahSound(soundId);
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: isSelected
                            ? gold.withValues(alpha: dark ? 0.15 : 0.08)
                            : cardBg,
