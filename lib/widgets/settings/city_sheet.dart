...
class _CitySheetState extends State<CitySheet> {
  ...
  Widget build(BuildContext context) {
    ...
    // Group by first letter for section headers when not searching
    final selectedName = provider.manualCityName;
              ...
              child: filtered.isEmpty
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          Icon(Icons.search_off, size: 40, color: textSec.withOpacity(0.4)),
                      ...
                      itemBuilder: (ctx, i) {
                        ...
                        return GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: isSelected
                                  ? teal.withOpacity(dark ? 0.15 : 0.08)
                                  : cardBg,
                              borderRadius: BorderRadius.circular(14),
                              border: Border.all(
